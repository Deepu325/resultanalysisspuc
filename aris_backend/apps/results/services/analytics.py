...
class TopperDataCleaner:
    ...
    def _normalize_percentage(value) -> float:
        ...
        try:
            ...
            print(f"⚠️ Invalid percentage: {value}, defaulting to 0.0")
            return 0.0
    ...
    def _normalize_stream(value) -> str or None:
        ...
        print(f"⚠️ Invalid stream: {value}, defaulting to None")
        return None
...
class StrictAnalyticsEngine:
    ...
    def _compute_toppers(self) -> Dict[str, List[Dict]]:
        ...
        print("✓ Toppers computed (college + stream)")
        return toppers
    ...
    def _compute_section_toppers(self) -> Dict[str, List[Dict]]:
        ...
        Section toppers use SIMPLIFIED format (no rank):
        - reg_no, student_name, percentage, class_name only
        ...
        print(f"✓ Section-wise toppers computed for {len(section_toppers)} sections")
    ...
    def _compute_section_performance(self) -> List[Dict]:
        ...
        print(f"✓ Section performance computed ({len(section_performance)} sections)")
    ...
    def _compute_subject_analysis(self) -> Dict[str, Any]:
        ...
        if not subjects:
            print("ℹ No subject columns found, skipping subject analysis")
            return {}
        ...
        print(f"✓ Subject analysis computed ({len(subject_analysis)} subjects)")
    ...
    def generate(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"❌ Analytics validation failed: {str(e)}")
            return {
                "status": "error",
                "message": str(e),
